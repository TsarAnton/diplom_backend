...
//         await queryRunner.query(`CREATE TABLE "log" ("id" SERIAL NOT NULL, "type" boolean NOT NULL, "date" TIMESTAMP NOT NULL, "login_id" character varying(15) NOT NULL, "operating_system" character varying(50) NOT NULL, "deleted_date" TIMESTAMP, "computer_id" integer, CONSTRAINT "PK_21715c86ee3f24604e88e3183a8" PRIMARY KEY ("id"))`);
...
//         await queryRunner.query(`CREATE TABLE "period_computer_work" ("id" SERIAL NOT NULL, "dateStart" TIMESTAMP NOT NULL, "dateEnd" TIMESTAMP, "operatingSystem" character varying NOT NULL, "loginId" character varying NOT NULL, "deleted_date" TIMESTAMP, "computer_id" integer, CONSTRAINT "PK_79d21f2b4f9d427d8c73ff50776" PRIMARY KEY ("id"))`);
