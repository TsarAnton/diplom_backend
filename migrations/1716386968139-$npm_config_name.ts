...
//         await queryRunner.query(`CREATE TABLE "log" ("id" SERIAL NOT NULL, "type" boolean NOT NULL, "date" TIMESTAMP NOT NULL, "login_id" character varying(15), "operating_system" character varying(50) NOT NULL, "deleted_date" TIMESTAMP, "computer_id" integer, CONSTRAINT "PK_21715c86ee3f24604e88e3183a8" PRIMARY KEY ("id"))`);
//         await queryRunner.query(`CREATE TABLE "day_computer_work" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "hours" real NOT NULL, "operatingSystem" character varying NOT NULL, "deleted_date" TIMESTAMP, "computer_id" integer, CONSTRAINT "PK_95270ed89b73407fae52d8f0485" PRIMARY KEY ("id"))`);
//         await queryRunner.query(`CREATE TABLE "month_computer_work" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "hours" real NOT NULL, "operatingSystem" character varying NOT NULL, "deleted_date" TIMESTAMP, "computer_id" integer, CONSTRAINT "PK_086daffae963c0ed84996886cf7" PRIMARY KEY ("id"))`);
//         await queryRunner.query(`CREATE TABLE "period_computer_work" ("id" SERIAL NOT NULL, "dateStart" TIMESTAMP NOT NULL, "dateEnd" TIMESTAMP, "operatingSystem" character varying NOT NULL, "loginId" character varying, "deleted_date" TIMESTAMP, "computer_id" integer, CONSTRAINT "PK_79d21f2b4f9d427d8c73ff50776" PRIMARY KEY ("id"))`);
//         await queryRunner.query(`CREATE TABLE "computer" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "macAddress" character varying(12) NOT NULL, "ipAddress" character varying(15) NOT NULL, "audince" character varying(20), "deleted_date" TIMESTAMP, CONSTRAINT "UQ_00f65c9fb51bd6ca58b3c76ef5c" UNIQUE ("macAddress"), CONSTRAINT "PK_775250089fb372f5edcfa2e5f95" PRIMARY KEY ("id"))`);
//         await queryRunner.query(`CREATE TABLE "year_computer_work" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "hours" real NOT NULL, "operatingSystem" character varying NOT NULL, "deleted_date" TIMESTAMP, "computer_id" integer, CONSTRAINT "PK_209b99e058d086b9f28606881d2" PRIMARY KEY ("id"))`);
...
//         await queryRunner.query(`ALTER TABLE "log" ADD CONSTRAINT "FK_de5801b708e0eb78433cab7b3a3" FOREIGN KEY ("computer_id") REFERENCES "computer"("id") ON DELETE RESTRICT ON UPDATE RESTRICT`);
...
//         await queryRunner.query(`ALTER TABLE "log" DROP CONSTRAINT "FK_de5801b708e0eb78433cab7b3a3"`);
